...
0;b._numItems=0;b._numItemsLoaded=null;b._scriptOrder=null;b._loadedScripts=null;b.TAG_LOAD_OGGS=true;b.initialize=function(a){this._targetProgress=this._numItemsLoaded=this._numItems=0;this._paused=false;this._currentLoads=[];this._loadQueue=[];this._scriptOrder=[];this._loadedScripts=[];this._loadedItemsById={};this._loadedItemsBySrc={};this.typeHandlers={};this.extensionHandlers={};this._loadStartWasDispatched=false;this.useXHR=a!=false&&g.XMLHttpRequest!=null;this.determineCapabilities()};b.determineCapabilities=
function(){var f=a.lib.BrowserDetect;if(f!=null)a.TAG_LOAD_OGGS=f.isFirefox||f.isOpera};a.isBinary=function(f){switch(f){case a.IMAGE:case a.SOUND:return true;default:return false}};b.installPlugin=function(a){if(!(a==null||a.getPreloadHandlers==null)){a=a.getPreloadHandlers();if(a.types!=null)for(var b=0,e=a.types.length;b<e;b++)this.typeHandlers[a.types[b]]=a.callback;if(a.extensions!=null)for(b=0,e=a.extensions.length;b<e;b++)this.extensionHandlers[a.extensions[b]]=a.callback}};b.setMaxConnections=
function(a){this._maxConnections=a;this._paused||this._loadNext()};b.loadFile=function(a,b){a==null?this._sendError({text:"File is null."}):(this._addItem(a),b!==false&&this.setPaused(false))};b.loadManifest=function(a,b){var e;if(a instanceof Array){if(a.length==0){this._sendError({text:"Manifest is empty."});return}e=a}else{if(a==null){this._sendError({text:"Manifest is null."});return}e=[a]}for(var c=0,g=e.length;c<g;c++)this._addItem(e[c],false);b!==false&&this._loadNext()};b.load=function(){this.setPaused(false)};
...
this._currentLoads.push(f);f.load()}}};b._handleFileError=function(a){var a=a.target,b=this._createResultData(a.getItem());this._numItemsLoaded++;this._updateProgress();this._sendError(b);this.stopOnError||(this._removeLoadItem(a),this._loadNext())};b._createResultData=function(a){var b={id:a.id,result:null,data:a.data,type:a.type,src:a.src};this._loadedItemsById[a.id]=b;return this._loadedItemsBySrc[a.src]=b};b._handleFileComplete=function(b){var b=b.target,d=b.getItem(),e=this._createResultData(d);
this._removeLoadItem(b);e.result=b instanceof a.lib.XHRLoader?this._createResult(d,e):d.tag;switch(d.type){case a.IMAGE:if(b instanceof a.lib.XHRLoader){var c=this;e.result.onload=function(){c._handleFileTagComplete(d,e)};return}break;case a.JAVASCRIPT:if(this.maintainScriptOrder){this._loadedScripts[this._scriptOrder.indexOf(d)]=d;this._checkScriptLoadOrder(b);return}}this._handleFileTagComplete(d,e)};b._checkScriptLoadOrder=function(){for(var a=this._loadedScripts.length,b=0;b<a;b++){var e=this._loadedScripts[b];
if(e===null)break;if(e!==true){var c=this.getResult(e.src),e=this.getResult(e.id);e.result=c.result;this._handleFileTagComplete(c,e);this._loadedScripts[b]=true;b--;a--}}};b._handleFileTagComplete=function(a,b){this._numItemsLoaded++;a.completeHandler&&a.completeHandler(b);this._updateProgress();this._sendFileComplete(b);this._loadNext()};b._removeLoadItem=function(a){for(var b=this._currentLoads.length,e=0;e<b;e++)if(this._currentLoads[e]==a){this._currentLoads.splice(e,1);break}};b._createResult=
function(b,d){var e=null,c;switch(b.type){case a.IMAGE:e=this._createImage();break;case a.SOUND:e=b.tag||this._createAudio();break;case a.CSS:e=this._createLink();break;case a.JAVASCRIPT:e=this._createScript();break;case a.XML:if(g.DOMParser){var h=new DOMParser;h.parseFromString(d,"text/xml")}else h=new ActiveXObject("Microsoft.XMLDOM"),h.async=false,h.loadXML(d),c=h;break;case a.JSON:case a.TEXT:c=d}return e?(b.type==a.CSS?e.href=b.src:e.src=b.src,e):c};b._handleProgress=function(a){var a=a.target,
b=this._createResultData(a.getItem());b.progress=a.progress;this._sendFileProgress(b);this._updateProgress()};b._updateProgress=function(){var a=this._numItemsLoaded/this._numItems,b=this._numItems-this._numItemsLoaded;if(b>0){for(var e=0,c=0,g=this._currentLoads.length;c<g;c++)e+=this._currentLoads[c].progress;a+=e/b*(b/this._numItems)}this._sendProgress({loaded:a,total:1})};b._createLoadItem=function(b){var d={};switch(typeof b){case "string":d.src=b;break;case "object":b instanceof HTMLAudioElement?
(d.tag=b,d.src=d.tag.src,d.type=a.SOUND):d=b}d.ext=this._getNameAfter(d.src,".");if(!d.type)d.type=this.getType(d.ext);if(d.id==null||d.id=="")d.id=d.src;if(b=this.typeHandlers[d.type]||this.extensionHandlers[d.ext]){b=b(d.src,d.type,d.id,d.data);if(b===false)return null;else if(b!==true){if(b.src!=null)d.src=b.src;if(b.id!=null)d.id=b.id;if(b.tag!=null&&b.tag.load instanceof Function)d.tag=b.tag}d.ext=this._getNameAfter(d.src,".")}b=this.useXHR;switch(d.type){case a.JSON:case a.XML:case a.TEXT:b=
true;break;case a.SOUND:d.ext=="ogg"&&a.TAG_LOAD_OGGS&&(b=false)}if(b)return new a.lib.XHRLoader(d);else if(d.tag)return new a.lib.TagLoader(d);else{var e,b="src",c=false;switch(d.type){case a.IMAGE:e=this._createImage();break;case a.SOUND:e=this._createAudio();break;case a.CSS:b="href";c=true;e=this._createLink();break;case a.JAVASCRIPT:c=true,e=this._createScript()}d.tag=e;return new a.lib.TagLoader(d,b,c)}};b.getType=function(b){switch(b){case "jpeg":case "jpg":case "gif":case "png":return a.IMAGE;
case "ogg":case "mp3":case "wav":return a.SOUND;case "json":return a.JSON;case "xml":return a.XML;case "css":return a.CSS;case "js":return a.JAVASCRIPT;default:return a.TEXT}};b._getNameAfter=function(a,b){var c=a.lastIndexOf(b),c=a.substr(c+1),g=c.lastIndexOf(/[\b|\?|\#|\s]/);return g==-1?c:c.substr(0,g)};b._createImage=function(){return document.createElement("img")};b._createAudio=function(){var a=document.createElement("audio");a.autoplay=false;a.type="audio/ogg";return a};b._createScript=function(){var a=
document.createElement("script");a.type="text/javascript";return a};b._createLink=function(){var a=document.createElement("link");a.type="text/css";a.rel="stylesheet";return a};b.toString=function(){return"[PreloadJS]"};a.proxy=function(a,b){return function(c){return a.apply(b,arguments)}};a.lib={};g.PreloadJS=a;c.init=function(){var a=navigator.userAgent;c.isFirefox=a.indexOf("Firefox")>-1;c.isOpera=g.opera!=null;c.isIOS=a.indexOf("iPod")>-1||a.indexOf("iPhone")>-1||a.indexOf("iPad")>-1};c.init();
a.lib.BrowserDetect=c})(window);(function(){var g=function(a,b,c){this.init(a,b,c)},c=g.prototype=new AbstractLoader;c._srcAttr=null;c._loadTimeOutTimeout=null;c.tagCompleteProxy=null;c.init=function(a,b,c){this._item=a;this._srcAttr=b||"src";this._useXHR=c==true;this.isAudio=a.tag instanceof HTMLAudioElement;this.tagCompleteProxy=PreloadJS.proxy(this._handleTagLoad,this)};c.cancel=function(){this._clean();var a=this.getItem();if(a!=null)a.src=null};c.load=function(){this._useXHR?this.loadXHR():this.loadTag()};c.loadXHR=function(){var a=
