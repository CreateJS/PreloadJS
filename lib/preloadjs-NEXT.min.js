...
**/(function(){var c=this.createjs=this.createjs||{},c=c.PreloadJS=c.PreloadJS||{};c.version="NEXT";c.buildDate="Mon, 22 Apr 2013 18:22:54 GMT"})();this.createjs=this.createjs||{};
...
0;b.target=this;b.type="progress";this.onProgress&&this.onProgress(b);this.dispatchEvent(b)}};a._sendComplete=function(){this._isCanceled()||(this.onComplete&&this.onComplete({target:this}),this.dispatchEvent("complete"))};a._sendError=function(d){if(!this._isCanceled())d==null&&(d={}),d.target=this,d.type="error",this.onError&&this.onError(d),this.dispatchEvent(d)};a._isCanceled=function(){return window.createjs==null||this.canceled?true:false};a._parseURI=function(d){return!d?null:d.match(c.FILE_PATTERN)};
a._formatQueryString=function(d,b){if(d==null)throw Error("You must specify data.");var e=[],a;for(a in d)e.push(a+"="+escape(d[a]));b&&(e=e.concat(b));return e.join("&")};a.buildPath=function(a,b,e){if(b!=null){var j=this._parseURI(a);if(j[1]==null||j[1]=="")a=b+a}if(e==null)return a;b=[];j=a.indexOf("?");if(j!=-1)var f=a.slice(j+1),b=b.concat(f.split("&"));return j!=-1?a.slice(0,j)+"?"+this._formatQueryString(e,b):a+"?"+this._formatQueryString(e,b)};a.toString=function(){return"[PreloadJS AbstractLoader]"};
