...
/**
 * Simple Script to do browser detection between libraries
 * @module BrowserDetect
 */
(function(window){

	/**
	 * Detemermine the current browser, version, operating system, and other environment variables.
	 * @class BrowserDetect
	 * @constructor
	 */
